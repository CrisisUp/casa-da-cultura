        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-areia bg-areia/50">
              <th className="px-4 py-3 text-left text-sm font-medium text-madeira/60">
                Nome
              </th>
              <th className="px-4 py-3 text-left text-sm font-medium text-madeira/60">
                CPF
              ...
              <th className="px-4 py-3 text-right text-sm font-medium text-madeira/60">
                Ações
              </th>
            </tr>
          </thead>
          <tbody className="divide-y divide-areia">
            {artistas.map((artista) => (
              <tr key={artista.id} className="hover:bg-areia/50 transition-colors">
                ...
                <td className="px-4 py-3 text-sm text-madeira/60">
